                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="box-footer col-xs-12">
                                                @if(count($result['products'])> 0 && $result['products'][0]->products_type==1)
                                                <a id="append_new_url" href="{{ URL::to("admin/products/attach/attribute/display/".$result['products'][0]->products_id) }}" class="btn btn-default pull-left">{{ trans('labels.AddOptions') }}</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
...
$('.product-type').on('change',function(){
    var val = $(this).val();
    $('#append_new_url').attr('href',"{{ URL::to('admin/products/attach/attribute/display/') }}/"+val);
})
</script>
@endpush